...
export const api = {
  ...
  createCategory: async (data: Partial<MenuCategory>) => {
    const res = await apiClient.post<{ success: boolean; data: MenuCategory }>(
      "/categories",
      data,
    );
    return res.data.data;
  ...
  updateCategory: async (id: string, data: Partial<MenuCategory>) => {
    const res = await apiClient.put<{ success: boolean; data: MenuCategory }>(
      `/categories/${id}`,
      data,
    );
    return res.data.data;
...
getTodayTransactions: async () => {
  ...
  const res = await apiClient.get<{
    ...
    `/transactions?startDate=${date}&endDate=${date}&page=1&limit=1000`
  );
  ...
  getIngredients: async (params?: {
    ...
    const res = await apiClient.get<{ success: boolean; data: Ingredient[] }>(
      `/inventory?${query.toString()}`,
    );
    return res.data.data;
  },
  createIngredient: async (data: any) => {
    const res = await apiClient.post<{ success: boolean; data: Ingredient }>(
      "/inventory",
      data,
    );
    return res.data.data;
  ...
  updateIngredient: async (id: string, data: any) => {
    const res = await apiClient.put<{ success: boolean; data: Ingredient }>(
      `/inventory/${id}`,
      data,
    );
    return res.data.data;
  ...
  getStockOpnames: async (params?: {
    ...
    if (params?.startDate) query.append("startDate", params.startDate);
    if (params?.endDate) query.append("endDate", params.endDate);
    const res = await apiClient.get<{ success: boolean; data: StockOpname[] }>(
      `/inventory/stock-opname?${query.toString()}`,
    );
    return res.data.data;
  },
  performStockOpname: async (data: any) => {
    const res = await apiClient.post<{ success: boolean; data: StockOpname }>(
  ...
  getClosingHistory: async () => {
    const res = await apiClient.get<{ success: boolean; data: CashClosing[] }>(
      "/cash-closing",
    );
    return res.data.data;
  },
  submitClosing: async (data: any) => {
    const res = await apiClient.post<{ success: boolean; data: CashClosing }>(
      "/cash-closing",
      data,
    );
    return res.data.data;
  ...
  getHourlyAnalytics: async (date?: string) => {
    ...
    const res = await apiClient.get<{
      success: boolean;
      data: HourlyAnalyticsData;
    }>(`/reports/hourly${query}`);
    return res.data.data;
  },
  ...
  getProductReport: async (params?: {
    ...
    if (params?.endDate) query.append("endDate", params.endDate);
    const res = await apiClient.get<{ success: boolean; data: any[] }>(
      `/reports/products?${query.toString()}`,
    );
    return res.data.data;
  },
  ...
  getWhatsAppReport: async (type: "sales" | "stock", date?: string) => {
    ...
    const res = await apiClient.get<{
      success: boolean;
      data: { text: string; type: string; date: string };
  ...
  createUser: async (data: any) => {
    const res = await apiClient.post<{ success: boolean; data: User }>(
      "/users",
      data,
    );
    return res.data.data;
  ...
  updateUser: async (id: string, data: any) => {
    const res = await apiClient.put<{ success: boolean; data: User }>(
      `/users/${id}`,
      data,
    );
    return res.data.data;
  ...
  getSettings: async () => {
    const res = await apiClient.get<{
      success: boolean;
      data: { list: any[]; map: Record<string, string> };
    }>("/settings");
    return res.data.data;
  },
